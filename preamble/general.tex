...
\usepackage{floatrow}
\usepackage{caption}
\captionsetup{format=hang,font=tiny,labelfont={sc},margin=5pt} %scriptsize instead of small
\usepackage{subcaption}
\captionsetup[sub]{margin=0pt,font=tiny,labelfont={rm}} %scriptsize instead of small
\usepackage{multirow}
\usepackage{booktabs}
...
% new command for rotating cells in tables
\newcommand{\rotcell}[1]{%
  \rotatebox[origin=c]{90}{%
    \begin{minipage}{2.75cm} % Adjust the width as needed
      \centering #1
    \end{minipage}%
  }%
}
...
\usepackage{threeparttable}  % For three-part tables
\usepackage{capt-of}     % For captions outside of floats
% \usepackage{parskip}     % For paragraph spacing

% for rotating entire tables
\usepackage{lscape}
\usepackage{vcell}
