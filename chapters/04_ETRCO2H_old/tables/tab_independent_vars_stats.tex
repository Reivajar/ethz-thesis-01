...
\resizebox{\linewidth}{!}{%
\begin{tabular}{>{\hspace{0pt}}m{0.417\linewidth}>{\RaggedLeft\hspace{0pt}}m{0.1\linewidth}>{\RaggedLeft\hspace{0pt}}m{0.1\linewidth}>{\RaggedLeft\hspace{0pt}}m{0.1\linewidth}>{\RaggedLeft\hspace{0pt}}m{0.09\linewidth}>{\RaggedLeft\hspace{0pt}}m{0.11\linewidth}} 
\toprule
